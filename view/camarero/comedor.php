...
<?php
    ...
    $capacidad=$pdo->prepare("SELECT DISTINCT capacidad_mesa FROM tbl_mesas WHERE ubicacion_mesa='comedor'");
    $capacidad->execute();
...
if(isset($_POST['filtrar'])){
    ...
    $select=$pdo->prepare("SELECT * FROM tbl_mesas WHERE ubicacion_mesa='comedor' ORDER BY capacidad_mesa DESC");
    $select->execute();
    ...
    //Filtrar solo por capacidad    
            ...
            //------------
            $select=$pdo->prepare("SELECT * FROM tbl_mesas WHERE capacidad_mesa=$capacidad and ubicacion_mesa='comedor' ORDER BY capacidad_mesa DESC");
